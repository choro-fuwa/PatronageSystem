...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public void checkStrategyAlerts() {
        ...
        try {
            // 获取所有运行中的策略
            List<com.patronage.strategy.entity.Strategy> runningStrategies = strategyService.getRunningStrategies();
            
            for (com.patronage.strategy.entity.Strategy strategy : runningStrategies) {
                try {
